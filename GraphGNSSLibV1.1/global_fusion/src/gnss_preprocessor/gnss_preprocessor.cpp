...
//    std::cout << "out_folder: " << out_folder << std::endl;
    ...
    prcopt.refpos = refpos;					// 0:pos in prcopt, 1:average of single pos, 2:read from file, 3:rinex header, 4:rtcm pos
